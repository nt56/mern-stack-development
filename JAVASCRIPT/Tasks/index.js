...
root.render(
    <React.StrictMode>
        ...
        {/* CSS  -  style={{key:value}}*/}
        <h1 style={{ color: 'orange', backgroundColor: 'black' }} className="heading">CSS Styling In React JSX</h1>
        ...
        <h1>Your name Is {name} and Your Skill Is {skill}</h1>
        <h1>{300 + 400}</h1>
        ...
        <button className="btn btn-primary fw-bold m-4 px-4">Welcome To Bootstrap</button>
